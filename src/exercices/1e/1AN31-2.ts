  ...
  nouvelleVersion() {
    ...
    for (let i = 0, cpt = 0; i < this.nbQuestions && cpt < 50; ) {
      ...
      const b = randint(-10, 10)
          ...
          & = \\mathrm{e}^x \\times (${reduireAxPlusB(a, b)}) + \\mathrm{e}^x \\times ${a} \\\\
           & = \\mathrm{e}^x \\left(${reduireAxPlusB(a, b)} + ${a}\\right) \\\\
          &=  (${reduireAxPlusB(a, a+b)})\\mathrm{e}^x
          \\end{aligned}$.`
      ...
      const racine = new FractionEtendue(-b, a).simplifie()
          ...
          & = \\dfrac{${k}\\mathrm{e}^x \\times (${reduireAxPlusB(a, b)}) - ${ecritureParentheseSiNegatif(k)}\\mathrm{e}^x \\times ${a}}{(${reduireAxPlusB(a, b)})^2} \\\\
           & = \\dfrac{${k}\\mathrm{e}^x \\left(${reduireAxPlusB(a, b)} - ${a}\\right)}{(${reduireAxPlusB(a, b)})^2} \\\\
          &=  \\dfrac{ ${k}\\mathrm{e}^x(${reduireAxPlusB(a,(b-a))})}{(${reduireAxPlusB(a, b)})^2}
          \\end{aligned}$.`
      ...
      const b = randint(-10, 10)
        const k = randint(-5, 5,[0,1,-1])
          ...
          & = \\dfrac{${k}\\mathrm{e}^x \\left(${a} - (${reduireAxPlusB(a, b)})\\right)}{\\left(${k}\\mathrm{e}^x\\right)^2} \\\\
           ...
           &=  \\dfrac{${reduireAxPlusB(-a, a - b)}}{${k}\\mathrm{e}^x}
          \\end{aligned}$.`
