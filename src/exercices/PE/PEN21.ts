    ...
    for (let i = 0, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      ...
      switch (listeTypeDeQuestions[i]) {
        case 'vers_base_10':
          ...
          texteCorr = `$(${n})_${b}=${n.toString()[0]}\\times${b}+${n.toString()[1]}=${miseEnEvidence(parseInt(n.toString(), b))}$`
          texteCorr += `<br>$(${m})_${b}=${m.toString()[0]}\\times${b}^3+${m.toString()[1]}\\times${b}^2+${m.toString()[2]}\\times${b}+${m.toString()[3]}=${miseEnEvidence(parseInt(m.toString(), b))}$`
          break
        ...
        case 'plus_grand_4_chiffres':
          ...
          texteCorr += `<br> $(10000)_${b}=1\\times${b}^4=${texNombre(b ** 4)}$ donc $(${b - 1}${b - 1}${b - 1}${b - 1})_${b}=${b ** 4}-1=${miseEnEvidence(texNombre(b ** 4 - 1))}$.`
          break
        case 'plus_grand_3_chiffres':
          ...
          texteCorr += `<br> $(1000)_${b}=1\\times${b}^3=${texNombre(b ** 3)}$ donc $(${b - 1}${b - 1}${b - 1})_${b}=${b ** 3}-1=${miseEnEvidence(texNombre(b ** 3 - 1))}$.`
          break
        ...
        case 'plus_petit_3_chiffres':
          ...
          texteCorr += `<br> $(100)_${b}=1\\times${b}^2=${texNombre(b ** 2)}$ donc $(${b - 1}${b - 1})_${b}=${b ** 2}-1=${miseEnEvidence(texNombre(b ** 2 - 1))}$.`
          break
      }
