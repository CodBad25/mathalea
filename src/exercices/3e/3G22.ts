...
const texFractionDecimal = (
  numerateur: Decimal.Value,
  denominateur: Decimal.Value,
) =>
  texFractionReduite(
    new Decimal(numerateur).toNumber(),
    new Decimal(denominateur).toNumber(),
  )
const fractionSimplifieeDecimal = (
  numerateur: Decimal.Value,
  denominateur: Decimal.Value,
) =>
  fractionSimplifiee(
...
export default class AgrandissementReduction extends Exercice {
  ...
  declare timeoutHandle: ReturnType<typeof setTimeout> | null
  declare quatrieme: boolean
  declare sup: number
  declare sup2: number
  ...
  nouvelleVersion(_numeroExercice: number) {
    ...
    let texteCorr = ''
    let r = new Decimal(0)
    let r2 = new Decimal(0)
    let h1 = new Decimal(0)
    let h2 = new Decimal(0)
    let h3 = new Decimal(0)
    let c = new Decimal(0)
    let c2 = new Decimal(0)
    let kprime = new Decimal(0)
    ...
    switch (choix) {
      case 1: {
        ...
        texte +=
          ...
          `(arrondie à $0,01\\text{cm}^2$ près).${ajouteQuestionMathlive({
            ...
            objetReponse: { reponse: { value: texNombre(c.mul(c), 2) } },
          ...
          ` $SABCD$ (arrondi à $0,001\\text{cm}^3$ près)${ajouteQuestionMathlive(
            {
              ...
              reponseParams: { formatInteractif: 'mathalea-mathfield' },
              objetReponse: {
                reponse: { value: texNombre(c.mul(c).mul(h1).div(3), 3) },
              },
              texteApres: ' $\\text{ cm}^3$',
              texteAvant: '  ',
            },
          ...
          ` $A'B'C'D'$ sachant que $SO'${sp()}=${sp()}${texNombre(h2, 0)}${sp()}\\text{cm}$ (arrondie à $0,01\\text{cm}^2$ près)${ajouteQuestionMathlive(
            {
              ...
              reponseParams: { formatInteractif: 'mathalea-mathfield' },
              objetReponse: {
                reponse: { value: texNombre(c.mul(h2).div(h1).pow(2), 2) },
              },
              texteAvant: '  ',
              texteApres: ' $\\text{ cm}^2$',
            },
          ...
          ` Calculer le volume de la pyramide $SA'B'C'D'$ (arrondi à $0,001\\text{cm}^3$ près)${ajouteQuestionMathlive(
            {
              ...
              objetReponse: {
                reponse: {
                  value: texNombre(
                    h2.div(h1).pow(3).mul(h1).mul(c.pow(2)).div(3),
                    3,
                  ),
                },
              },
              ...
              reponse: {
                value: texNombre(
                  h1
                    ...
                    .mul(c)
                    .div(3)
                    .sub(h2.div(h1).pow(3).mul(h1).mul(c.pow(2)).div(3)),
                  3,
                ),
              },
            },
        ...
        if (!h1.isInteger() || pgcd(h2.toNumber(), h1.toNumber()) > 1) {
          texteCorr += `=${texFractionDecimal(h2.mul(10), h1.mul(10))}$.<br>`
        } else {
          texteCorr += '.$<br>'
        }
      ...
      case 2: // calcul de l'aire de base, du volume d'un cône. puis, calcul de la section, du volume du cône réduit et du volume du tronc
        ...
        texte +=
          ...
          ` (arrondie à $0,01\\text{cm}^2$ près).${ajouteQuestionMathlive({
            ...
            reponseParams: { formatInteractif: 'mathalea-mathfield' },
            objetReponse: {
              reponse: { value: texNombre(r.pow(2).mul(Math.PI), 2) },
            },
            texteAvant: ' ',
            texteApres: ' $\\text{cm}^2$',
          })}<br>`
        ...
        texte +=
          ...
          ` (arrondi à $0,001\\text{cm}^3$ près).${ajouteQuestionMathlive({
            ...
            objetReponse: {
              reponse: {
                value: texNombre(h1.mul(Math.PI).mul(r.pow(2)).div(3), 3),
              },
            },
            texteAvant: ' ',
            texteApres: ' $\\text{cm}^3$',
          ...
          ` sachant que $SO'=${texNombre(h2, 0)}${sp()}\\text{cm}$ (arrondie à $0,01\\text{cm}^2$ près).${ajouteQuestionMathlive(
            {
              ...
              objetReponse: {
                reponse: {
                  value: texNombre(
                    r.pow(2).mul(Math.PI).mul(h2.pow(2)).div(h1.pow(2)),
                    2,
                  ),
                },
              },
          ...
          ` Calculer le volume du cône de hauteur $SO'$ (arrondi à $0,001\\text{cm}^3$ près).${ajouteQuestionMathlive(
            {
              ...
              objetReponse: {
                reponse: {
                  value: texNombre(
                    r.pow(2).mul(Math.PI).mul(h2.pow(3)).div(h1.pow(2)).div(3),
                    3,
                  ),
                },
              },
              ...
              reponse: {
                value: texNombre(
                  h1
                    ...
                    .mul(r.pow(2))
                    .div(3)
                    .mul(new Decimal(1).sub(h2.div(h1).pow(3))),
                  3,
                ),
              },
            },
      ...
      case 3: // calcul de l'aire de base, du volume d'une pyramide à base triangulaire. puis, calcul de la section, du volume de la petite pyramide et du volume du tronc
        ...
        texte +=
          ...
          ` (arrondie à $0,01\\text{cm}^2$ près).${ajouteQuestionMathlive({
            ...
            reponseParams: { formatInteractif: 'mathalea-mathfield' },
            objetReponse: {
              reponse: { value: texNombre(c.mul(c2).div(2), 2) },
            },
            texteAvant: ' ',
            texteApres: ' $\\text{cm}^2$',
          })}<br>`
        texte +=
          ...
          ` (arrondi à $0,001\\text{cm}^3$ près).${ajouteQuestionMathlive({
            ...
            objetReponse: {
              reponse: {
                value: texNombre(c.mul(c).mul(h1).div(6), 3),
              },
            },
            texteAvant: ' ',
            texteApres: ' $\\text{cm}^3$',
        ...
        texte +=
          ...
          ` (arrondie à $0,01\\text{cm}^2$ près).${ajouteQuestionMathlive({
            ...
            objetReponse: {
              reponse: {
                value: texNombre(
                  c.mul(c2).div(2).mul(h2.pow(2)).div(h1.pow(2)),
                  2,
                ),
              },
            },
        ...
        texte +=
          ...
          ` (arrondi à $0,001\\text{cm}^3$ près).${ajouteQuestionMathlive({
            ...
            objetReponse: {
              reponse: {
                value: texNombre(
                  c.mul(c).mul(h1).div(6).mul(h2.pow(3)).div(h1.pow(3)),
                  3,
                ),
              },
            },
              ...
              reponse: {
                value: texNombre(
                  c
                    ...
                    .mul(h1)
                    .div(6)
                    .mul(new Decimal(1).sub(h2.pow(3).div(h1.pow(3)))),
                  3,
                ),
              },
            },
        ...
        texteCorr += `Dans une réduction de coefficient $k$, les aires sont multipliés par $k^2$.<br>`
        texteCorr += `Donc son aire est $\\left(${texFractionDecimal(h2.mul(10), h1.mul(10))}\\right)^2 \\times ${texNombre(c.mul(c2).div(2), 3)}$ $\\text{cm}^2$ $=${texFractionDecimal(h2.mul(h2).mul(100).mul(c).mul(c2), h1.mul(h1).mul(200))} \\text{cm}^2 \\approx ${texNombre(h2.div(h1).pow(2).mul(c).mul(c2).div(2), 2)}$ $\\text{cm}^2$.<br>`
        texteCorr +=
          numAlpha(3) +
          ` Dans une réduction de coefficient $k$, les volumes sont multipliés par $k^3$.<br>`
        texteCorr += `Donc le volume de la pyramide $SO'A'B'$ est : $\\left(${texFractionDecimal(h2.mul(10), h1.mul(10))}\\right)^3 \\times \\dfrac{${texNombre(c.mul(c2).mul(h1).div(2), 3)}}{3} \\text{cm}^3 \\approx ${texNombre(h2.pow(3).mul(c).mul(c2).div(h1.pow(2)).div(6), 3)} \\text{cm}^3$ '.<br>`
        texteCorr += numAlpha(4) + ' Le volume du tronc de la pyramide est : '
      ...
      case 4: // Un tronc de cône étant donné (seau), calcul de la hauteur du cône dont il est issu, de son volume, puis du volume du seau. Lecture graphique du volume d'eau à mi hauteur et calcul de ce volume
        ...
        r2 = new Decimal(randint(11, r.mul(10).sub(3).toNumber())).div(10)
        ...
        texte += `Sa hauteur intérieure est de $${texNombre(h3, 1)}${sp()}$dm, sa petite base a un diamètre intérieur de $${texNombre(r2.mul(2))}${sp()}$dm et sa grande base (l'ouverture) a un diamètre intérieur de $${texNombre(r.mul(2))}${sp()}$dm.<br>`
        if (!context.isHtml) {
          texte += "La figure n'est pas en vraie grandeur.<br>"
        }
        texte +=
...
\\end{tikzpicture} \n\t \\end{minipage}`
        ...
        if (
          !r.isInteger() ||
          pgcd(r2.mul(10).toNumber(), r.mul(10).toNumber()) > 1
        ) {
          texteCorr += `=${texFractionDecimal(r2.mul(10), r.mul(10))}$.<br>`
        } else {
          texteCorr += '.$<br>'
        }
        ...
        if (context.isHtml) {
          texteCorr +=
            numAlpha(3) +
            ` Il faut fixer HL à ${texNombre(r.mul(10))} cm ; BA à ${texNombre(r2.mul(10), 0)} cm ; BH à ${texNombre(h3.mul(10), 0)} cm et la hauteur d'eau à ${texNombre(h1.sub(h2).mul(5), 1)} cm.<br>`
      ...
      case 5: // Un problème avec un cône Vanille Chocolat.
        ...
        texteCorr += `Donc $K = \\sqrt[3]{1 - \\left(${texFractionDecimal(h2.mul(10), h1.mul(10))}\\right)^3} \\approx ${texNombre(kprime, 5)}$.<br>`
