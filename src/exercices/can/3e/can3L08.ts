...
export default class EnFonctionDeAire extends ExerciceSimple {
      ...
      case 1:
  {
    ...
    if (choice([true, false])) {
      ...
      const consigne = "L'aire de la partie non hachurée en fonction de $x$ est : "
      ...
      const consigne = "L'aire de la partie  hachurée en fonction de $x$ est : "
      this.question = intro + consigne
      if (!this.interactif) this.question += ' $\\ldots \\text{ cm}^2$.'
      this.canEnonce = intro + consigne
  ...
  break
    ...
    const intro = '$AEFG$ et $EBCD$ sont des carrés et $EM=x$.<br>' + figure
