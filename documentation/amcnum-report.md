...
| 13 | [src/exercices/can/2e/can2C15.ts](src/exercices/can/2e/can2C15.ts) |  | Pour obtenir du Latex avec une FractionEtendue, il faut utiliser sa propriété texFraction ! |
| 14 | [src/exercices/can/2e/can2G01.ts](src/exercices/can/2e/can2G01.ts) |  | Pour obtenir du Latex avec une FractionEtendue, il faut utiliser sa propriété texFraction ! |
| 15 | [src/exercices/can/2e/can2P01.ts](src/exercices/can/2e/can2P01.ts) |  | Pour obtenir du Latex avec une FractionEtendue, il faut utiliser sa propriété texFraction ! |
| 16 | [src/exercices/can/3e/can3C03.ts](src/exercices/can/3e/can3C03.ts) |  | Pour obtenir du Latex avec une FractionEtendue, il faut utiliser sa propriété texFraction ! |
| 17 | [src/exercices/can/3e/can3C04.ts](src/exercices/can/3e/can3C04.ts) |  | Pour obtenir du Latex avec une FractionEtendue, il faut utiliser sa propriété texFraction ! |
| 18 | [src/exercices/can/3e/can3C14.ts](src/exercices/can/3e/can3C14.ts) |  | Pour obtenir du Latex avec une FractionEtendue, il faut utiliser sa propriété texFraction ! |
| 19 | [src/exercices/can/3e/can3C22.ts](src/exercices/can/3e/can3C22.ts) |  | Pour obtenir du Latex avec une FractionEtendue, il faut utiliser sa propriété texFraction ! |
| 20 | [src/exercices/can/4e/can4C02.ts](src/exercices/can/4e/can4C02.ts) |  | Pour obtenir du Latex avec une FractionEtendue, il faut utiliser sa propriété texFraction ! |
| 21 | [src/exercices/can/4e/can4C03.ts](src/exercices/can/4e/can4C03.ts) |  | Pour obtenir du Latex avec une FractionEtendue, il faut utiliser sa propriété texFraction ! |
| 22 | [src/exercices/can/4e/can4C05.ts](src/exercices/can/4e/can4C05.ts) |  | Pour obtenir du Latex avec une FractionEtendue, il faut utiliser sa propriété texFraction ! |
| 23 | [src/exercices/can/4e/can4C07.ts](src/exercices/can/4e/can4C07.ts) |  | Pour obtenir du Latex avec une FractionEtendue, il faut utiliser sa propriété texFraction ! |
| 24 | [src/exercices/can/4e/can4C10.ts](src/exercices/can/4e/can4C10.ts) |  | Pour obtenir du Latex avec une FractionEtendue, il faut utiliser sa propriété texFraction ! |
| 25 | [src/exercices/can/4e/can4C12.ts](src/exercices/can/4e/can4C12.ts) |  | Pour obtenir du Latex avec une FractionEtendue, il faut utiliser sa propriété texFraction ! |
| 26 | [src/exercices/can/4e/can4C16.ts](src/exercices/can/4e/can4C16.ts) |  | Pour obtenir du Latex avec une FractionEtendue, il faut utiliser sa propriété texFraction ! |
...
| 39 | [src/exercices/can/6e/can6G02.ts](src/exercices/can/6e/can6G02.ts) | [erreur-runtime] (Cannot set properties of null (setting 'fillStyle')) |  |
| 40 | [src/exercices/can/6e/can6G03.ts](src/exercices/can/6e/can6G03.ts) | [erreur-runtime] (Cannot set properties of null (setting 'fillStyle')) |  |
| 41 | [src/exercices/can/6e/can6G06.ts](src/exercices/can/6e/can6G06.ts) | [erreur-runtime] (Cannot set properties of null (setting 'fillStyle')) |  |
| 42 | [src/exercices/can/6e/can6M11.ts](src/exercices/can/6e/can6M11.ts) | [erreur-runtime] (Cannot set properties of null (setting 'fillStyle')) |  |
