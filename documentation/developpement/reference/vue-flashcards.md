...
Panneau latéral, persisté dans `localStorage` (`mathaleaFlashcardsView`) : format (A4/A5), orientation, cartes par ligne (1 à 4), lignes par page (1 à 6), taille du texte, polices (texte et maths, mêmes listes que la vue Typst), numérotation des cartes.
